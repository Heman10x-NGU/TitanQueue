...
// Warning: The underlying redis connection pool will not be closed by TitanQueue, you are responsible for closing it.
...
func (c *Client) Close() error {
	if c.sharedConnection {
		return fmt.Errorf("redis connection is shared so the Client can't be closed through titanqueue")
	}
